            ...
            listener: (context, state) {
              if (state is OtpVerifyLoading) {
                ...
                ScaffoldMessenger.of(context).showSnackBar(
                    const SnackBar(content: Text("Verify Success")));
              } else if (state is OtpVerifyFail) {
                EasyLoading.dismiss();
                ScaffoldMessenger.of(context)
                    .showSnackBar(const SnackBar(content: Text("Verify Fail")));
              }
            },
            child: Padding(
                      ...
                      child: ElevatedButton(
                        onPressed: isAllValid()
                            ? () {
                                context
                                    .read<OtpBloc>()
                                    .add(OtpVerifyPressed(otps: otps));
                              }
                            : null,
